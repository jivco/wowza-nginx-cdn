...
WOW_APP='dvr'
SMIL='smil'
NGX_APP_DIR=$WOW_APP/$1.$SMIL
WOW_URL="http://$2:1935/$WOW_APP/$1.$SMIL"
...
NGX_BITRATE1=$NGX_ROOT'/'$NGX_APP_DIR'/'$NGX_BITRATE_URL1
NGX_BITRATE2=$NGX_ROOT'/'$NGX_APP_DIR'/'$NGX_BITRATE_URL2
...
NGX_MAIN_PLAYLIST=$NGX_APP_DIR'/playlist.m3u8'
# in seconds
CHUNKDURATION=5
# in hours
DVR_WINDOW=8
